...
var functionsLock sync.RWMutex
...
func getFunction(name string) (*Function, bool) {
	functionsLock.RLock()
	defer functionsLock.RUnlock()
	function, ok := Functions[name]
	return function, ok
}

// RegisterCustomFunction registers a custom function.
func RegisterCustomFunction(fn *Function) {
	functionsLock.Lock()
	defer functionsLock.Unlock()
	Functions[fn.Name] = fn
}

// UnregisterCustomFunction is a test function to remove a custom function.
