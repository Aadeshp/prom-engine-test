...
// GraphiteExpr represents a graphite expression.
type GraphiteExpr struct {
	GraphiteExpr string
	EndPos       PositionRange
}

var _ Expr = (*GraphiteExpr)(nil)

func (g *GraphiteExpr) PositionRange() PositionRange {
	return g.EndPos
}
func (g *GraphiteExpr) String() string {
	return g.GraphiteExpr
}

func (g *GraphiteExpr) Type() ValueType {
	return "graphite"
}

func (g *GraphiteExpr) PromQLExpr() {
}
