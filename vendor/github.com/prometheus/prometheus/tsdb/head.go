...
func (a *initAppender) Append(typ textparse.MetricType, ref uint64, lset labels.Labels, t int64, v float64) (uint64, error) {
	if a.app != nil {
		return a.app.Append(typ, ref, lset, t, v)
	}
...
func (a *headAppender) Append(typ textparse.MetricType, ref uint64, lset labels.Labels, t int64, v float64) (uint64, error) {
	if t < a.minValidTime {
